    ...
    return (
        <section className="bg-[#f1f2ed] py-8 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-6 md:px-8 lg:px-12">
            <div className="max-w-7xl mx-auto">
                <h2
                    className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-black font-bold text-center mb-8 sm:mb-12 md:mb-16 lg:mb-20"
                    data-aos="fade-up"
                >
