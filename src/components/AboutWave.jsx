    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 sm:gap-7 md:gap-8 relative z-10 mt-8 sm:mt-10 md:mt-15">
        ...
        >
          ...
          >
            Reimagine cooking with <strong>Wave</strong>. Designed to <br className="hidden xs:inline" />
            simplify mealtime, our microwave combines stylish <br className="hidden xs:inline" /> aesthetics
            with high-performance heating <br className="hidden xs:inline" /> technology.
          </motion.p>
