...
const AboutHero = () => {
    ...
    // Handle cursor movement within this section
    ...
    return (
        ...
        >
            ...
            {/* Hero Content */}
            <div className="relative z-10 flex flex-col items-center justify-center h-screen px-4 sm:px-6 md:px-8">
                {/* Optional hero content here */}
            </div>

            {/* Custom Cursor (Only visible inside this section) */}
            {showCursor && (
                <div
